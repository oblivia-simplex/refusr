...
mutable struct Node
    ...
    Node(d::Int, c::Bool, v::CONST_TYPE, f::Int, o::Int, l::Node, r::Node) =
        new(d, c, v, f, o, l, r)
end
...
"""
Node(op::Int, l::Union{AbstractFloat,Int}) =
    Node(1, false, convert(CONST_TYPE, 0.0f0), 0, op, Node(l))
"""
...
"""
Node(op::Int, l::Union{AbstractFloat,Int}, r::Node) =
    Node(2, false, convert(CONST_TYPE, 0.0f0), 0, op, Node(l), r)
"""
...
"""
Node(op::Int, l::Node, r::Union{AbstractFloat,Int}) =
    Node(2, false, convert(CONST_TYPE, 0.0f0), 0, op, l, Node(r))
"""
...
"""
Node(op::Int, l::Union{AbstractFloat,Int}, r::Union{AbstractFloat,Int}) =
    Node(2, false, convert(CONST_TYPE, 0.0f0), 0, op, Node(l), Node(r))
"""
...
"""
Node(var_string::String, varMap::Array{String,1}) =
    Node([i for (i, _variable) in enumerate(varMap) if _variable == var_string][1]::Int)
